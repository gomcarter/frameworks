...
public abstract class BaseApi implements DisposableBean, InitializingBean {
     ...
     * @return result
     */
    protected String httpExcute(Method method, String urlKey, Map<String, Object> params, List<String> restParams, String body, Map<String, String> headers, Map<String, File> files) {
